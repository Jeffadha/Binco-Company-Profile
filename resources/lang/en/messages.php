...
return [
    ...
    'Tim R&D & QC Profesional' => 'Professional R&D & QC Team',
    'Inovasi berbasis penelitian dengan standar kualitas tertinggi' => 'Research-based innovation with the highest quality standards',

    'Jaringan Distribusi Luas' => 'Extensive Distribution Network',
    'Akses produk kami tersedia di seluruh Indonesia dengan dukungan logistik terintegrasi' => 'Our products are available throughout Indonesia with integrated logistics support',
    ...
    "Keunggulan" => "The Advantages of Our",
    "Solusi Agribisnis" => "Agribusiness Solutions",
    "Kami" => "",
    "Kami menghadirkan pendekatan terintegrasi yang menggabungkan penelitian mutakhir, kontrol kualitas laboratorium, dan dukungan teknis lapangan untuk memastikan produk yang konsisten, aman, dan efektif bagi mitra kami." => "We offer an integrated approach combining cutting-edge research, laboratory quality control, and field technical support to ensure consistent, safe, and effective products for our partners.",
    "Standar QC Ketat & Uji Laboratorium" => "Strict QC Standards & Laboratory Testing",
    "Setiap produk melalui proses quality control multi-tahap dengan teknologi laboratorium modern untuk memastikan kualitas terbaik." => "Every product undergoes a multi-stage quality control process using modern lab technology to ensure top quality.",
    "Solusi Terpersonalisasi" => "Personalized Solutions",
    "Kami menyediakan solusi yang dapat disesuaikan dengan kebutuhan spesifik berbagai komoditas dan kondisi geografis." => "We provide solutions tailored to the specific needs of various commodities and geographic conditions.",
    ...
    'education_features' => [
        ...
        'Learn modern planting systems (fertigation & smart plant).',
        'See firsthand the use of cocopeat & natural growing media.',
    ],
    ...
    'tab_pendukung' => 'Supporting Products',

    // Cocopeat
    'cocopeat_judul' => 'Cocopeat (Organic Growing Media)',
    'cocopeat_deskripsi' => 'A fine powder from processed coconut fiber as an alternative soil-free growing medium. We produce two types:',
    'cocopeat_block' => 'Cocopeat Block (Press 5 Kg): Ideal for export (Low EC & High EC).',
    'cocopeat_loose' => 'Cocopeat Loose (Bagged): Ready to use for hydroponics and nurseries.',
    'keunggulan' => 'Advantages:',
    'cocopeat_features' => [
        'High water retention & optimal air circulation.',
        '100% organic and eco-friendly.',
        'Maintains humidity & neutral pH.',
        'Sterile and pathogen-free.',
    ],

    // Cocopot
    'cocopot_judul' => 'Cocopot (Organic Plant Pot)',
    'cocopot_deskripsi' => 'A natural pot made from coconut fiber designed to replace plastic pots. Available in various sizes for horticultural and ornamental plants.',
    'cocopot_features' => [
        'Eco-friendly and biodegradable.',
        'Strengthens plant root systems.',
        'Adds natural aesthetics.',
    ],

    // Cocorope
    'cocorope_judul' => 'Cocorope (Coconut Fiber Rope)',
    'cocorope_deskripsi' => 'Natural rope made from coconut fibers, strong and weather-resistant. Used in agriculture, construction, decoration, and household needs.',
    'varian' => 'Variants:',
    'cocorope_features' => [
        'Cocorope Roll',
        'Cocomesh & Coconet (Netting)',
        'Custom orders for agriculture and decoration.',
    ],

    // Pendukung
    'pendukung_judul' => 'Supporting Products',
    'pendukung_deskripsi' => 'Besides our main products, we also produce various natural agricultural and coconut fiber derivatives.',
    'produk_lainnya' => 'Other Products:',
    'pendukung_features' => [
        'Coconut fiber doormats',
        'Cocobristle brushes',
        'Telescopic duster',
        'Charcoal husk and fermented manure.',
    ],

    //katalog produk
    'katalog_icon_alt' => 'Catalog Icon',
    'katalog_judul' => 'Product',
    'katalog_highlight' => 'Catalog',
    'katalog_deskripsi' => 'See our complete collection of featured products.',
    'katalog_button' => 'View All Products',
    ...
    //TESTIMONI
    'testimoni_judul' => 'What Our',
    'testimoni_highlight' => 'Clients Say',
    'testimoni_deskripsi' => 'Hear directly from partners and customers who have experienced the benefits of our agribusiness solutions.',

    'testimoni_1_isi' => '“Seed products from Binco Indofarm have significantly increased our harvest yields. Their responsive and solution-oriented technical support makes us trust their service quality even more.”',
    'testimoni_1_nama' => 'Mr. Santoso',
    'testimoni_1_jabatan' => 'Tobacco Farmer, Grobogan',

    'testimoni_2_isi' => '“Our distribution partnership with Binco Indofarm runs very smoothly. Stock is always available on time and the product quality remains consistent. They are a reliable and professional business partner.”',
    'testimoni_2_nama' => 'PT AgroLog Indonesia',
    'testimoni_2_jabatan' => 'Main Distributor',

    //Galerry
    'galeri_judul' => 'Product & QC Gallery',
    'galeri_highlight' => 'Products & QC',
    'galeri_deskripsi' => 'Documentation of production processes, quality control, and finished products ensuring the best quality for you.',
    ...
    'faq_question_3' => 'What are the advantages of Cocopeat products compared to other planting media?',
    ...
    'faq_answer_2_block_point2' => 'Easy to store and re-expand',
    'faq_answer_2_block_point3' => 'Suitable for export and long-distance distribution',
    ...
    'faq_answer_4_program1_desc' => 'Learn modern farming systems (fertigation & smart plant)',
    ...
    'faq_answer_5_partnership2' => 'Agriculture industry, nurseries, and urban farming',
    'faq_answer_5_partnership3' => 'Hotels, cafes, and green decoration centers',
    'faq_answer_5_partnership4' => 'Educational institutions & research agencies',
    'faq_answer_5_process_title' => 'Partnership Process',
    'faq_answer_5_step1' => 'Contact our marketing team via WhatsApp/email',
    'faq_answer_5_step2' => 'Consultation on needs and partnership potential',
    'faq_answer_5_step3' => 'Partnership proposal submission',
    ...
    'faq_answer_6_agriculture2' => 'Burnt husk (additional planting media)',
    'faq_answer_6_agriculture3' => 'Kohe (fermented manure)',
    'faq_answer_6_household_title' => 'Household & Industrial Products',
    'faq_answer_6_household1' => 'Coconut coir doormats',
    ...
    'faq_cta_email' => 'Send Email',

    // About Page
    'about_title' => 'About PT Binco Ran Indofarm',
    'about_hero_title' => 'About PT Binco Ran Indofarm',
    'about_hero_subtitle' => '"Transforming Coconut Waste into Sustainable Green Solutions"',
    ...
    'about_feature2_title' => 'Sustainable Agriculture',
    ...
    'about_greenhouse_paragraph2' => 'We also open the <strong>"Melon Picking Tourism & Agricultural Education"</strong> program, which serves as an educational, recreational, and inspirational facility for the general public, students, and business partners.',
    'about_greenhouse_activities_title' => 'Tourism Activities:',
    ...
    'about_partnership_point2' => 'Agricultural industry, nurseries, and urban farming',
    'about_partnership_point3' => 'Hotels, cafes, and green decoration centers',
    'about_partnership_point4' => 'Educational Institutions & Research Agencies',
    'about_partnership_point5' => 'Local government & Farming communities',
