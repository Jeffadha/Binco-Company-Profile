...
<head>
    ...
    <style>
        ...
        /* Sembunyikan attribution Google */
        .goog-logo-link {
            display: none !important;
        }
        .goog-te-gadget {
...
<div class="flex-shrink-0">
    <a href="/" class="flex items-center">
        ...
        <!-- Logo text with single line tagline -->
        <div class="ml-3 flex flex-col">
            ...
            <span class="text-xs text-gray-600 dark:text-gray-300 font-medium mt-0.5 leading-tight tracking-wide">
                ...
                <div class="hidden sm:flex items-center space-x-8">
                    <a href="/"
                        class="{{ Request::is('/') ? 'text-emerald-500 dark:text-white' : 'text-gray-600 dark:text-gray-300' }} hover:text-slate-900 dark:hover:text-white transition-all duration-300 font-semibold">Beranda</a>
                    <a href="{{ route('about') }}"
                        class="{{ Request::is('about') ? 'text-emerald-500 dark:text-white' : 'text-gray-600 dark:text-gray-300' }} hover:text-slate-900 dark:hover:text-white transition-all duration-300 font-semibold">Tentang
                        Kami</a>
                    <a href="{{ route('product') }}"
                        class="{{ Request::is('product') ? 'text-emerald-500 dark:text-white' : 'text-gray-600 dark:text-gray-300' }} hover:text-slate-900 dark:hover:text-white transition-all duration-300 font-semibold">Produk</a>
                    <a href="{{ route('blogs') }}"
                        class="{{ Request::is('blogs') ? 'text-emerald-500 dark:text-white' : 'text-gray-600 dark:text-gray-300' }} hover:text-slate-900 dark:hover:text-white transition-all duration-300 font-semibold">Artikel</a>
                    <a href="{{ route('contact') }}"
                        class="{{ Request::is('contact') ? 'text-emerald-500 dark:text-white' : 'text-gray-600 dark:text-gray-300' }} hover:text-slate-900 dark:hover:text-white transition-all duration-300 font-semibold">Kontak
                        Kami</a>
                </div>
                ...
                <div class="flex items-center">
                    <div class="hidden sm:flex items-center space-x-6">
                        ...
                        @guest
                        <a href="{{ route('login') }}"
                            class="text-gray-600 dark:text-gray-300 hover:text-emerald-500 transition font-semibold">Masuk</a>
                        <a href="{{ route('register') }}"
                            class="bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-4 py-2 rounded-md hover:opacity-90 transition font-semibold">Daftar</a>
                        @else
