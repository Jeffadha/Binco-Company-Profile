...
<body class="min-h-screen bg-gray-50 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300 flex flex-col">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <!-- Company -->
            <div>
                <h3 class="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider">PT Binco Ran Indofarm</h3>
                <p class="text-gray-500 dark:text-gray-400 mt-2">Perusahaan agribisnis modern yang berfokus pada pengolahan sabut kelapa dan penyediaan media tanam alami untuk pertanian berkelanjutan.</p>
            </div>
            ...
            <div>
                ...
                <a href="/about" class="block text-gray-500 dark:text-gray-400 hover:text-emerald-500 mt-2">Tentang Kami</a>
                <a href="/products" class="block text-gray-500 dark:text-gray-400 hover:text-emerald-500 mt-2">Produk</a>
                <a href="/contact" class="block text-gray-500 dark:text-gray-400 hover:text-emerald-500 mt-2">Kontak</a>
            </div>
            ...
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400 mt-1 text-sm">Jl. Suruh, Kayuapak, Polokarto, Sukoharjo, Jawa Tengah 57555</p>
            </div>
        ...
        <div>
            ...
            <div class="flex space-x-3 mt-2">
                <a href="https://instagram.com/binco.indofarm" target="_blank" class="text-gray-400 hover:text-emerald-500">
                ...
                <a href="https://tiktok.com/@binco.indofarm" target="_blank" class="text-gray-400 hover:text-emerald-500">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://youtube.com/@binco.indofarm" target="_blank" class="text-gray-400 hover:text-emerald-500">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-12 border-t border-gray-100 dark:border-gray-700 pt-8">
            <p class="text-center text-gray-400 dark:text-gray-500">© {{ date('Y') }} PT Binco Ran Indofarm. All rights reserved.</p>
        </div>
    </div>
    </footer>
