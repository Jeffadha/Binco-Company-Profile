...
<style>
    ...
    .content-preview {
        max-width: 350px;
        display: -webkit-box;
        -webkit-line-clamp: 3; /* jumlah baris preview */
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <input type="text" id="searchInput" class="form-control form-control-sm" placeholder="Search posts...">
                </div>
                                    ...
                                    <form action="{{ route('admin.posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="content" class="form-control ckeditor" rows="6">{{ $post->content }}</textarea>

                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Current Image</label><br>
                                                <img src="{{ asset($post->image) }}" class="img-thumbnail mb-2" style="height:90px;">
